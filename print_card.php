...
<!-- search form-->
    ...
    <div class="popup-message <?php echo $message_type == 'error' ? 'error' : ''; ?>" id="popupMessage">
        <div class="popup-header">
            <span class="popup-title"><?php echo $message_type == 'error' ? 'Warning!' : 'Success!'; ?></span>
            <button class="popup-close" onclick="document.getElementById('popupMessage').style.display='none';">&times;</button>
        </div>
      ...
      <form class="form-inline" method="POST" action="" style="width: 50%;padding-top:30px;">
        ...
        <fieldset>
            ...
            <div class="account-details">
                ...
                <div><label>Receipt Number *</label><input type="text" name="rep-number" onclick="logAction('Clicked Receipt Number Input')" value = "<?php echo $rcpnumber; ?>" style="text-transform: uppercase;" 
                <?php echo empty($rcpnumber) ? 'required' : 'readonly'; ?>></div>
                
                <div><label>Cash Recieved *</label>
                    <div class="radio_flex">
                        <input id='radio-1' type="radio" name='cash_rec' value="YES" required>
                        <label for="radio-1">Yes</label>
                        <input id='radio-2' type="radio" name='cash_rec' value="NO" required>
...
.popup-message {
        ...
        .popup-message.error {
            border-left-color: #ff6c00; /* Red border for errors */
        }
        ...
        .popup-message .popup-header .popup-title {
            font-weight: bold;
            color: #4CAF50; /* Green for success title */
        }
        .popup-message.error .popup-title {
            color: #ff6c00; /* Red for error title */
        }
