...
$rowID = !empty($_SESSION['formRowID']) ? $_SESSION['formRowID'] : null;
$sum_ins = !empty($_SESSION['formsumIns']) ? $_SESSION['formsumIns'] : null;
$editStatus = !empty($_SESSION['formEditStatus']) ? $_SESSION['formEditStatus'] : null;
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="tab_container">
        ...
        <div class="table-responsive" >
          <form id="coverForm" action="mqFormEdit.php" method="POST">
            <table class="custom-table">
              ...
              <tbody id="coverTable">
                ...
                <td>
                 ...
                 <td style='text-align: right;'><b><?php echo $ncb_amt ?></b></td>
                 </tr>
                <?php
            ...
            ";
                ...
                <td style='text-align: right;' id="total-contribution"><b><?php $tot2 = $total01 + $total02; echo $total2NUMBER = number_format($tot2, 2, '.', '');?></b></td>
                </tr>
                <?php
          ...
          ";
                ...
                <td style='text-align: right;' id="total-contribution"><b><?php $tot5 = $tot4 + $total05; echo $total2NUMBER = number_format($tot5, 2, '.', '');?></b></td>
                </tr>
        ...
        <div>
        <button id="form-edit" class="save-button" type="button" >Re Cal</button>
      </div> 
      <script>
