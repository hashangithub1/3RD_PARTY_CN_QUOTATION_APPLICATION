...
$sql=mysqli_query($con,"select code from tbl_company_mt where code ='$code'");
...
if($row>0)
{
    ...
    $stmt = $con->prepare("INSERT INTO tbl_company_mt(code, name, description) VALUES (?, ?, ?)");
...
if($msg)
{
        ...
        $newNotification = [
            'message' => 'New Company added to the Comprehensive', 
            'time' => $currentTime,
            'is_read' => false
        ];
...
$result = mysqli_query($con, "SELECT * FROM tbl_company_mt");
?>
...
<body>
  ...
  <div class="container-scroller">
    ...
    <!-- Add New Button -->
    <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#addNewModal">Add New Company</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addNewModalLabel">Create Company</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" name="adduser" onsubmit="return checkpass();">
                    <div class="form-group">
                        <label for="productCode">Company Code *</label>
                        <input class="form-control" id="pcode"  name="code" type="text" placeholder="Enter product code" required>
                    </div>
                    <div class="form-group">
                        <label for="productName">Company Name *</label>
                        <input class="form-control" id="pname" name="name" type="text" placeholder="Enter product name" required>
                    </div>
                    <div class="form-group">
                        <label for="productPremium">Description</label>
                        <input class="form-control" id="premium" name="desc" type="text" placeholder="Optional">
                    </div>
                    <div class="form-group">
                    
                    <?php
                          $sql = "SELECT code, name FROM tbl_business_channel_mt WHERE status = 1";
                          $result = $con->query($sql);
                    ?>
                        <label for="productPremium">Business Channel</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" name="editProductForm" action="update_company.php">
                    ...
                    <div class="form-group">
                        <label for="editProductChannel">Business Channel</label>
                        <input class="form-control" id="editChannel" name="editChannel" type="text">
                        <!-- <select class="form-control" name="editChannel" id="editChannel">
                            <option value=""></option>
                        </select> -->
                    </div>
    ...
    function editRecord(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#editChannel").val(companyDetails.buschannel);
