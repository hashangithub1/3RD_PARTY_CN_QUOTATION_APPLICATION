...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(500, 17, '                                         Motor 3rd Party Cover Note', 0, 0, 'L');
        // Line break
        $this->Ln(0);
...
Maximum Period of 30 DAYS from:', 1);
        ...
        $this->Cell(95, 5, 'Annual Takaful Contribution (Premium)', 1, 1, 'C', true);
         ...
         // Table content
         $this->SetFont('Arial', '', 7);
         $this->Cell(95, 5, '   1. Vehicle Make and Mode', 1);
         $this->Cell(95, 5, '', 1, 1);
    ...
    function Footer()
{
    ...
    $this->Image('3rd-Party-CN.png', 6, $this->GetY() + -2, 11);
