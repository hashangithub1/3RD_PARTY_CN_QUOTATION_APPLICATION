...
$basicrate_cont = !empty($_SESSION['basic_premium']) ? $_SESSION['basic_premium'] : null;
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="tab_container">
        ...
        <div class="table-responsive" style="display: <?php $form = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($form) && $form !== "") ? 'initial' : 'none'; ?>">
          <form id="coverForm" action="quo-pdf.php" method="POST">
            <table class="custom-table">
              ...
              <tbody id="coverTable">
                <tr>
                 ...
                 <td><input style='text-align: right;width: 100%;' type='number' class='value-input' value="<?php echo $sum_ins ?>" placeholder='0.0' readonly></td>
        ...
        <button id="form-exit" class="save-button" style="display: <?php $btn = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($btn) && $btn !== "") ? 'initial' : 'none'; ?>">Exit</button>
        ...
        <button id="form-print" class="save-button" type="button" style="display: <?php $btn = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($btn) && $btn !== "") ? 'initial' : 'none'; ?>">Print</button>
        </div> 
        <script>
          ...
          document.getElementById('form-exit').addEventListener('click', function() {
            document.getElementById('coverForm').action = 'reset-session.php';
            document.getElementById('coverForm').submit();
          });
        </script>        
        </div>
...
<?php
echo "<script type='text/javascript'> document.location = 'page.recal.php'; </script>";
?>
</body>
