...
$_SESSION['page_name'] = "page.recal.php";
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="tab_container">
          ...
          <form id="coverForm" action="quo-pdf.php" method="POST" target="_blank">
            <table class="custom-table">
              ...
              <tbody id="coverTable">
                ...
                <td><input style='text-align: right;width: 100%;' type='number' class='value-input' id='total-initial' placeholder='0.0' readonly></td>
                <td style='display:none'><input style='text-align: right;' type='number' class='value-input' value="" id='total-initial' placeholder='0.0' readonly></td>
        ...
        <button onclick="exitFunction()" class="save-button" style="display: <?php $btn = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($btn) && $btn !== "") ? 'initial' : 'none'; ?>">Exit</button>
        <button onclick="backFunction()" class="save-button" style="display: <?php $btn = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($btn) && $btn !== "") ? 'initial' : 'none'; ?>">Back</button>
