...
//echo 'SelectChannelCode: ' . $SelectChannelCode . '<br>';
...
$TotalContribution_OLD = !empty($_SESSION['TotalContribution']) ? $_SESSION['TotalContribution'] : null;
//SRCC TC Crages
...
if ($SelectCompanyCode === "lb001") {
    ...
    $rate_table = "vehicle_rates_leasing_other";
} elseif ($SelectCompanyCode === "pna001") {
    $rate_table = "vehicle_rates_leasing_other";
} else {
