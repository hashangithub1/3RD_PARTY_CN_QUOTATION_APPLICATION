...
$ncbRate = !empty($_SESSION['ncbRate']) ? $_SESSION['ncbRate'] : null;
$mrRate = !empty($_SESSION['mrRate']) ? $_SESSION['mrRate'] : null;
$ncb_MRamt = !empty($_SESSION['ncb_mr_Amt']) ? $_SESSION['ncb_mr_Amt'] : null;
...
$sql_mt = "INSERT INTO quotation_mt (quote_no, comp_codce, prod_code, class_code, cus_name, cus_address, cus_mobile, cus_email, vehi_number, vehi_reg_status, vehi_make_model, vehi_seating_capacity, vehi_year_of_manu, vehi_fuel_type, vehi_usage, sum_ins, ncb_rate, ncb_amt, mr_rate, mr_amt, vehi_rate, basic_rate, date_period, basic_premium, tot_premium, vat_amt, pol_fee, ssl_amt, admin_fee, prnt_status, cal_date, user_ID, user_brnch, edit_status) 
           VALUES ('$quote_no','$compCode','$prodcode','NULL','$clientName','$clientAddress','$mobile_number','$email_address','$vehiregNo','$registrationStatus','$makeModel','$seatingCapacity','$manufactureYear','$fuelType','$vehiusage','$sum_ins','$ncbRate','$ncb_MRamt','$mrRate','$ncb_MRamt','$rate','$basicrate','$datePeriod', '$basic_premium', '$totalPremium','$VATChargers','0','0','$adminChargers','$printStatus','$calDate','$B_username','$branch', '1')";
