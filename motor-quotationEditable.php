...
$comp_excesses     = !empty($_SESSION['comp_excesses']) ? $_SESSION['comp_excesses'] : null;
$remark            = !empty($_SESSION['remark']) ? $_SESSION['remark'] : null;
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="tab_container">
              ...
              <div class="form-column">
                  ...
                  <div class="form-group">
                      ...
                      <select name="buis_channel" id="channel_select" class="dropdown">
                          ...
                          <option value="ATI">Direct / ATI Sales Staff</option>
                  ...
                  <div class="form-group" id="company_div">
                      ...
                      <select name="company" id="company_select" class="dropdown">
                          ...
                          <?php
                          $sql = "SELECT * FROM tbl_company_mt WHERE bus_channel = '$SelectChannelCode' ";
        ...
        <div class="table-responsive" style="display: <?php $form = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($form) && $form !== "") ? 'initial' : 'none'; ?>">
          <form id="coverForm" action="motor-quotationFinal.php" method="POST">
            <table class="custom-table">
              ...
              <tbody id="coverTable">
                <tr>
                 ...
                 <td><input style='text-align: right;font-weight: bold;' type='text' id='edit-sumins' class='code-block-input' value='<?php echo $sum_ins1 ?>' placeholder='' readonly></td>
                 <script>
                  document.getElementById('edit-sumins').addEventListener('input', function (e) {
                      let input = e.target.value;

                      // Remove all non-numeric characters except the decimal point
                      input = input.replace(/[^0-9.]/g, '');

                      // Ensure only one decimal point exists and limit to two decimal places
          ...
          // Handle comma-separated initial amounts
            ...
            // set new array row to store calculated price.
                ...
                //Calculation Code between NCB and MR
                  ...
                  $readonly = ($edit_flag == 0) ? "readonly" : "";
                      ...
                      if (strpos($row['initial_amt'], ',') !== false) {
                          ...
                          // If there's no comma, display as an input box
                          echo "<input style='text-align: right;' type='number' class='value-input' name='initial_amt_B[]' value='" . $row['initial_amt'] . "' $readonly data-minlimit='$minLimit' data-maxlimit='$maxLimit' oninput='validateAmount(this)'>";
                      }
                      echo "</td>";
              ...
              <!-- END -->
                ...
                <td style='text-align: right;' id="total-contribution"><b><?php echo $T1RS = number_format($T1, 2);?></b></td>
                </tr>
          ...
          // Handle comma-separated initial amounts
            ...
            // set new array row to store calculated price.
                ...
                //Calculation Code between NCB and MR
                  ...
                  $readonly = ($edit_flag == 0) ? "readonly" : "";
                      ...
                      if (strpos($row['initial_amt'], ',') !== false) {
                          ...
                          // If there's no comma, display as an input box
                          echo "<input style='text-align: right;' type='number' class='value-input' name='initial_amt_B1[]' value='" . $row['initial_amt'] . "' $readonly data-minlimit='$minLimit' data-maxlimit='$maxLimit' oninput='validateAmount(this)'>";
                      }
                      echo "</td>";
                      ...
                      echo "</td>";
                      echo "<td style='text-align: right;'>" . $row['premium'] = number_format($row['premium'], 2) . "</td>";
                      echo "<td style='display:none;'><input style='text-align: right;' type='text' class='code-block-input' name='premium_B1[]' value='" . $row['premium'] . "'></td>";
                      ...
                      echo "<td style='display:none;'><input style='text-align: right;' type='text' class='code-block-input' name='cover_area_B1[]' value='" . $row['cover_area'] . "'></td>";
             ...
             // set new array row to store calculated price.
                 ...
                 //Calculation Code between NCB and MR
                   ...
                   //cover Edit option for specific users
                   $access_sernames = ["CHANAKA.KULIYAPITIYA" , "RIDMI.WIJAYABANDARA" , "MUMTAZ.MULAFFAR" , "VISHWA.VIJAN" , "ADEESHA.SAHAN" , "CHAMARA" , "sithija", "admin"];
                   $username = $_SESSION['u_name'];
                   if ((in_array($username , $access_sernames))){if ($cover_code == 'cov-025'){$edit_flag = 1;}}
                   //end
                   ...
                   $readonly = ($edit_flag == 0) ? "readonly" : "";
                      ...
                      echo "<td><input style='text-align: right;' type='number' class='value-input' name='initial_amt_B_ADM[]' value='" . $row['initial_amt'] . "' $readonly data-minlimit='$minLimit' data-maxlimit='$maxLimit' oninput='validateAmount(this)'></td>";
            ...
            // set new array row to store calculated price.
                ...
                //Calculation Code between NCB and MR
                  ...
                  $readonly = ($edit_flag == 0) ? "readonly" : "";
                      ...
                      echo "<td><input style='text-align: right;' type='number' class='value-input' name='initial_amt_B_ADM1[]' value='" . $row['initial_amt'] . "' $readonly data-minlimit='$minLimit' data-maxlimit='$maxLimit' oninput='validateAmount(this)'></td>";
            ...
            // set new array row to store calculated price.
                ...
                //Calculation Code between NCB and MR
                  ...
                  $readonly = ($edit_flag == 0) ? "readonly" : "";
                    ...
                    echo "<td><input style='text-align: right;' type='number' class='value-input' name='initial_amt_B_ADMT[]' value='" . $row['initial_amt'] . "' $readonly data-minlimit='$minLimit' data-maxlimit='$maxLimit' oninput='validateAmount(this)'></td>";
            ...
            //End Calculation Algorythm //
              ...
              <!-- End -->
                ...
                <?php
                      ...
                      echo "<td></td>";
                      echo "<td></td>";
                      echo "<td><input style='text-align: right;' type='text' id='cex-premium' class='code-block-input' placeholder='Nil' value='.$comp_excesses' name='comp_excesses[]'></td>";
                      echo "</tr>"; 
                ?>
                <!-- End -->
              </tbody>
            ...
            <?php
                ...
                echo "<input style='text-align: left; width: 100%; padding: 5px;' type='text' id='remark-note' class='code-block-input' placeholder='Comment Here' value='.$remark' name='remark[]'>";
                echo "</div>";
                echo "</div>";
                ?>
            <!-- End -->
        ...
        <button  onclick="exitFunction()" class="save-button" type="submit" style="display: <?php $btn = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($btn) && $btn !== "") ? 'initial' : 'none'; ?>">Exit</button>
        <button id="form-back" class="save-button" style="display: <?php $btn = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($btn) && $btn !== "") ? 'initial' : 'none'; ?>">Back</button>
        <button id="form-recal" class="save-button" style="display: <?php $btn = !empty($_SESSION['product']) ? $_SESSION['product'] : null; echo (isset($btn) && $btn !== "") ? 'initial' : 'none'; ?>">Calculate</button>
        <button id="form-save" class="save-button" style="display:none; ?>">Save</button>    
        <button id="form-print" class="save-button" type="button" style="display:none;">Print</button>  </div> 
      <script>
        ...
        //   document.getElementById('coverForm').action = 'motor-quotationFinal.php';
        //   document.getElementById('coverForm').submit();
        // });

        // Form submission with validation check
        document.getElementById('form-recal').addEventListener('click', function(event) {
        const invalidInputs = document.querySelectorAll('input.value-input.invalid');
        ...
        document.getElementById('form-back').addEventListener('click', function() {
          document.getElementById('coverForm').action = 'motor-quotation.php';
          document.getElementById('coverForm').submit();
        });
      </script>        
      </div>
...
function validateAmount(input) {
    const minLimit = parseFloat(input.getAttribute('data-minlimit'));
    const maxLimit = parseFloat(input.getAttribute('data-maxlimit'));
    const value = parseFloat(input.value);

    const recalButton = document.getElementById('form-recal'); // Select the button

    if (value < minLimit || value > maxLimit) {
        input.setCustomValidity(`Please enter a value between ${minLimit.toFixed(2)} and ${maxLimit.toFixed(2)}`);
        input.reportValidity();
        recalButton.style.display = 'none'; // Hide the button
    } else {
        input.setCustomValidity(''); // Clear any previous custom validation message
        recalButton.style.display = 'inline-block'; // Show the button
    }
}
