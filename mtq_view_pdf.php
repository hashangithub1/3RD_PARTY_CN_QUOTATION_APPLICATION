...
$ncb_MRamt = !empty($_SESSION['FORMEDIT_mr_amount']) ? $_SESSION['FORMEDIT_mr_amount'] : null;
...
$pdf->Cell(-5, 8, 'Rs. '. $gross_premium_ = number_format($gross_premium_,2), 0, 1, 'R');
...
//CLEAE SESSION
$_SESSION['mqForm_comp_excesses']          =   NULL;
$_SESSION['remark_rev']                 =   NULL;
//END
