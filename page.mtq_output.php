    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="tab_container">
        ...
        <div class="table-responsive" >
          <form id="coverForm" action="mtq_output_pdf.php" target="_blank" method="POST">
            <table class="custom-table">
              ...
              <tbody id="coverTable">
                ...
                <td><b>TOTAL 01</b></td>
                <td><input style='text-align: right;width: 100%;' type='number' class='value-input' id='total-initial' placeholder='0.0' readonly></td>
                <td style='text-align: right;' id="total-contribution"><b><?php echo $total1NUMBER = number_format($total2, 2); $_SESSION['T1_total01'] = $total2;?></b></td>
                </tr>
                <?php
                // Recalculation Process Bottum
